...
export const YAKU_DEFS: readonly YakuMeta[] = [
  { id: 'gokou', nameJa: '五光', nameZh: '五張光牌', evaluate: lightYaku(true, 4, 10) },
  { id: 'shikou', nameJa: '四光', nameZh: '四張光牌（不含雨）', evaluate: lightYaku(false, 4, 8) },
  { id: 'ameShikou', nameJa: '雨四光', nameZh: '含雨的四張光牌', evaluate: lightYaku(true, 3, 7) },
  { id: 'sankou', nameJa: '三光', nameZh: '三張光牌（不含雨）', evaluate: lightYaku(false, 3, 5) },
  {
    id: 'hanamiZake', nameJa: '花見酒', nameZh: '桜に幕＋菊に盃',
    enabled: (r) => r.hanamiZake, evaluate: setYaku([CURTAIN, SAKE_CUP], 5),
  },
  {
    id: 'tsukimiZake', nameJa: '月見酒', nameZh: '芒に月＋菊に盃',
    enabled: (r) => r.tsukimiZake, evaluate: setYaku([MOON, SAKE_CUP], 5),
  },
  { id: 'inoshikachou', nameJa: '猪鹿蝶', nameZh: '山豬＋鹿＋蝴蝶', evaluate: setYaku(INOSHIKACHOU, 5) },
  { id: 'akatan', nameJa: '赤短', nameZh: '松梅桜的赤短冊', evaluate: setYaku(POEM_RIBBONS, 5) },
  { id: 'aotan', nameJa: '青短', nameZh: '牡丹菊紅葉的青短冊', evaluate: setYaku(BLUE_RIBBONS, 5) },
  { id: 'tane', nameJa: 'タネ', nameZh: 'タネ牌 5 張起', evaluate: countYaku('tane', 5) },
  { id: 'tanzaku', nameJa: 'タン', nameZh: '短冊 5 張起', evaluate: countYaku('tanzaku', 5) },
  { id: 'kasu', nameJa: 'カス', nameZh: 'カス 10 張起', evaluate: countYaku('kasu', 10) },
];
...
export function yakuStatus(captured: readonly CardId[], rules: RuleConfig): YakuStatus[] {
  ...
  return YAKU_DEFS.filter((d) => d.enabled?.(rules) ?? true).map((d) => {
    ...
    return { id: d.id, nameJa: d.nameJa, nameZh: d.nameZh, met, points, needed };
  });
}
